...
<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
    <strong>Silahkan Login Dahulu!!!! </strong>
</div>
            ...
            <div class="container">
                <div class="col-sm-10 offset-sm-1">
                    <div class="login-brand">
                        ...
                        <h5>Together we make world better</h5>
                    </div>


                    <h5 class="text-black text-muted">Login Page</h5>
                    ...
                    ?>
                    <form method="post" action="includes/login-forum.inc.php" class="form-inline justify-content-center">
                        <div class="form-group">
                            <label class="sr-only">Name</label>
                            <input type="text" id="name" name="mailuid" class="form-control form-control-lg mr-1"
                                placeholder="Username">
                        </div>
                        <div class="form-group">
                            <label class="sr-only">Email</label>
                            <input type="password" id="password" name="pwd" class="form-control form-control-lg mr-1"
                                placeholder="Password">
                        </div>
                        <input type="submit" id="log-button" class="btn btn-dark btn-lg mr-1" name="login-submit"
                            value="Login">
                    </form>
