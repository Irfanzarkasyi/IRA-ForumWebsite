                ...
                <div class="row">
                    ...
                    <div class="col-sm-8" >
                        ...
                        <div class="text-center p-3">
                            <img id="home-logo" src="img/LOGO.png">
                            <h2 class='text-muted'>Home Page</h2>
                            <br>
                        </div>
                        ...
                        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" id="forum-tab" data-toggle="tab" href="#forum" role="tab" 
                                 aria-controls="forum" aria-selected="true">All Forums</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="blog-tab" data-toggle="tab" href="#blog" role="tab" 
                                 aria-controls="blog" aria-selected="false">All Blogs</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="poll-tab" data-toggle="tab" href="#poll" role="tab" 
                                 aria-controls="poll" aria-selected="false">All Polls</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="event-tab" data-toggle="tab" href="#event" role="tab" 
                                 aria-controls="event" aria-selected="false">All Events</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                  ...
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-white lh-100">All Forums</h1>
                                  </div>
                                </div>  
                                    ...
                                    ?>        
                                      <a class="btn btn-primary btn-lg btn-block" href="forum.php">
                                            View All forums</a>
                            ...
                            <div class="tab-pane fade" id="blog" role="blog" aria-labelledby="blog-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/LOGO.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-white lh-100">All Blogs</h1>
                                  </div>
                                </div>  
                                ...
                                <div class="row mb-2">
                                    ...
                                    ?>        
                                    <a class="btn btn-primary btn-lg btn-block" href="blogs.php">
                                            View All Blogs</a>
