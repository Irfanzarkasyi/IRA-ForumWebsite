            ...
            <div class='card card-profile text-center'>
                <img alt='' class='card-img-top card-user-cover' src='img/black-bg.jpg'>
                <div class='card-block'>
                    <a href='profile.php'>
                        <img src='uploads/<?php echo $_SESSION["userImg"] ?>' class='card-img-profile'>
                    </a>
                    <?php  
                        if ($_SESSION['userLevel'] == 1 || $_SESSION['userLevel'] == 0)
                        {
                            echo '<img id="card-admin-badge" style="height:150px;" src="img/admin-badge.png" ">';
                        }
                    ?>
